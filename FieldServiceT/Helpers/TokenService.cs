...
namespace FieldServiceT.Helpers
{
    ...
    {
        private readonly string tenantId;  // = "d9dad9e8-9725-4c21-8426-0df9b7fc5c77";
        private readonly string appKey;    // = "gRs6L1vWI82qk-cpkkp-3OKz-c92N36b.x";
        private readonly string clientId;  // = "6b542434-9649-4bb6-91c8-c2688e5b4024";
        private readonly string CRMHost;   // = "https://eg8pfua3iofsrjt3zb.crm.dynamics.com/";

        public TokenService(IConfiguration configuration)
        {
            tenantId = configuration["FieldService:TenantId"];
            appKey = configuration["FieldService:appKey"];
            clientId = configuration["FieldService:clientId"];
            CRMHost = configuration["FieldService:CRMHost"];
        }
